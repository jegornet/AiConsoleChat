...
и в конце unittest.main(verbosity=2) для запуска всех тестов БЕЗ if __name__ == '__main__':
Тесты должны использовать фреймворк unittest.
Критически важно выдавать только Python код простым текстом, не должно быть никакого дополнительного текста, никакой Markdown вёрстки. 
После выдачи тестов выполни их как обычный Python код через MCP функцию.
            """,
            messages=messages,
